const { createArrayFrom, fromHash } = require('./dataTable2Array.js');
...
module.exports = { createAdres, infrastructureelWijzigenAdres, actualiseerAdres, adressenSamenvoegen, splitsAdres }