...
Functionaliteit: Tonen van Nationaliteithistorie
  ...
  In het antwoord wordt indicatieNationaliteitBeeindigd opgenomen met de waarde true, wanneer in de actuele nationaliteit
  (categorie 04) GEEN nationaliteit (05.10) noch aanduiding bijzonder Nederlanderschap (65.10) is opgenomen, of wanneer in
  categorie 04 reden beëindigen nationaliteit (64.10) is opgenomen.

  Voor een beëindigde nationaliteit of beëindigd bijzonder Nederlanderschap worden de eigenschappen overgenomen uit de jongste
  bijbehorende historische categorie (54) waarin deze zijn voorkomen. Dit betreft de volgende eigenschappen:
  - nationaliteit
  - aanduidingBijzonderNederlanderschap
  - redenOpname

  Voor een nationaliteit (actueel of beëindigd) wordt de datumIngangGeldigheid gevuld met de datum geldigheid (85.10) uit
  de oudste bijbehorende categorie (04 of 54) waarin er een waarde is voor 05.10 of voor 65.10.

  Voor een beëindigde nationaliteit wordt de redenBeeindigen overgenomen uit de bijbehorende actuele categorie (04).

  Voor een beëindigde nationaliteit wordt datumEindeGeldigheid gevuld met de datum geldigheid (85.10) uit de oudste bijbehorende
  categorie (04 of 54) waarin er geen waarde is voor 05.10 noch voor 65.10.
  ...
  Een beëindigde nationaliteit waarbij de jongste bijbehorende historische categorie 54 met nationaliteit (05.10) gevuld én indicatie
  onjuist (84.10) gevuld, wordt niet opgenomen in het antwoord.
  Voor een actuele nationaliteit (niet-beëindigd) met een bijbehorende historische categorie 54 met indicatie onjuist, worden
  de gegevens (incl. datum ingang) in de onjuiste categorie genegeerd.

  In het antwoord worden de eerst de actuele nationaliteiten opgenomen, gevolgd door de beëindigde nationaliteiten
  (gesorteerd op indicatieNationaliteitBeeindigd). Daarbinnen worden resultaten aflopend gesorteerd op datumTot
  en vervolgens aflopend gesorteerd op datumIngangGeldigheid.
  ...
  Scenario: Nationaliteit is onjuist
    ...
    En worden de nationaliteiten teruggegeven in de volgorde en met waarden:
      | # | nationaliteit.code | datumIngangGeldigheid | datumToto            | redenOpname.code | redenBeeindigen.code |
