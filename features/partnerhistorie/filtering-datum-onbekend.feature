...
Rule: Wanneer Datum huwelijkssluiting/aangaan geregistreerd partnerschap geheel onbekend is, wordt voor de filtering aangenomen dat de persoon deze partner altijd heeft gehad.
	  ...
	  ???? Betekent dit dan ook dat als de peildatum ligt voor de geboortedatum van de persoon er geen partnerhistorie wordt opgenomen? 
	  ???? Of moeten we sowieso een regel opnemen voor als de peildatum ligt voor de geboortedatum van de persoon?
