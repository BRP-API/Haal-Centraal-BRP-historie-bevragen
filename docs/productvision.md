# Productvisie Haal Centraal BRP Historie Bevragen
...
In principe willen we voor iedere activiteit op een lokale kopie een Haal Centraal alternatief te bieden in de vorm van een API. Deze API betreft het opvragen van historische gegevens van een ingeschreven persoon.
...
gebruikt.
- De [Landelijke API strategie voor de overheid](https://geonovum.github.io/KP-APIs/) wordt waar mogelijk toegepast.
