...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VerblijfstitelhistorieHalCollectie")]
    public partial class VerblijfstitelhistorieHalCollectie : IEquatable<VerblijfstitelhistorieHalCollectie>, IValidatableObject
    {
        /// <summary>
        ...
        public VerblijfstitelhistorieHalCollectieEmbedded Embedded { get; set; }
        ...
        {
            return this.Equals(input as VerblijfstitelhistorieHalCollectie);
        }

        /// <summary>
        /// Returns true if VerblijfstitelhistorieHalCollectie instances are equal
        /// </summary>
        /// <param name="input">Instance of VerblijfstitelhistorieHalCollectie to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VerblijfstitelhistorieHalCollectie input)
        {
            if (input == null)
                return false;
