...
namespace Org.OpenAPITools.Model
{
    ...
    /// Verblijfplaats
    /// </summary>
    [DataContract(Name = "Verblijfplaats")]
    public partial class Verblijfplaats : IEquatable<Verblijfplaats>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Verblijfplaats);
        }

        /// <summary>
        /// Returns true if Verblijfplaats instances are equal
        /// </summary>
        /// <param name="input">Instance of Verblijfplaats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Verblijfplaats input)
        {
            if (input == null)
                return false;
