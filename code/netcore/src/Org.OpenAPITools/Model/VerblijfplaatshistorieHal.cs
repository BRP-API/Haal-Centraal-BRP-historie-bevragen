...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VerblijfplaatshistorieHal")]
    public partial class VerblijfplaatshistorieHal : IEquatable<VerblijfplaatshistorieHal>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as VerblijfplaatshistorieHal);
        }

        /// <summary>
        /// Returns true if VerblijfplaatshistorieHal instances are equal
        /// </summary>
        /// <param name="input">Instance of VerblijfplaatshistorieHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VerblijfplaatshistorieHal input)
        {
            if (input == null)
                return false;
