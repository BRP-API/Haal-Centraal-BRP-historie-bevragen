...
{
    /// <summary>
    /// Geeft aan welke gegevens over de geboorte van de persoon in onderzoek zijn. Zie de [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-BRP-bevragen/blob/v1.0.0/features/in_onderzoek.feature) 
    /// </summary>
    [DataContract(Name = "GeboorteInOnderzoek")]
    public partial class GeboorteInOnderzoek : IEquatable<GeboorteInOnderzoek>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as GeboorteInOnderzoek);
        }

        /// <summary>
        /// Returns true if GeboorteInOnderzoek instances are equal
        /// </summary>
        /// <param name="input">Instance of GeboorteInOnderzoek to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeboorteInOnderzoek input)
        {
            if (input == null)
                return false;
