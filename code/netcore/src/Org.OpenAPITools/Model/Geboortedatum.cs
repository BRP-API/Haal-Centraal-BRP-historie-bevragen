...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Geboortedatum")]
    public partial class Geboortedatum : IEquatable<Geboortedatum>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as Geboortedatum);
        }

        /// <summary>
        /// Returns true if Geboortedatum instances are equal
        /// </summary>
        /// <param name="input">Instance of Geboortedatum to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Geboortedatum input)
        {
            if (input == null)
                return false;
