...
namespace Org.OpenAPITools.Model
{
    ...
    /// PartnerhistorieHal
    /// </summary>
    [DataContract(Name = "PartnerhistorieHal")]
    public partial class PartnerhistorieHal : IEquatable<PartnerhistorieHal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerhistorieHal" /> class.
        /// </summary>
        ...
        public PartnerhistorieLinks Links { get; set; }
        ...
        {
            return this.Equals(input as PartnerhistorieHal);
        }

        /// <summary>
        /// Returns true if PartnerhistorieHal instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerhistorieHal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerhistorieHal input)
        {
            if (input == null)
                return false;
