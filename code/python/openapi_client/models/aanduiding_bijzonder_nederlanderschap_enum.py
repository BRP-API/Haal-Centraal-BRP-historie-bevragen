...
class AanduidingBijzonderNederlanderschapEnum(object):
    ...
    allowable_values = [BEHANDELD_ALS_NEDERLANDER, VASTGESTELD_NIET_NEDERLANDER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AanduidingBijzonderNederlanderschapEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AanduidingBijzonderNederlanderschapEnum):
            return False
