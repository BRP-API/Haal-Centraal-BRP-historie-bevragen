...
class SoortAdresEnum(object):
    ...
    allowable_values = [WOONADRES, BRIEFADRES]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """SoortAdresEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SoortAdresEnum):
            return False
